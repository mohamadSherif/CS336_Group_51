...
public class AddFlight extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		add.insertFlight(airline, departAirport, arriveAirport, departDate, arriveDate, departTime, arriveTime, firstPrice, busPrice, econPrice, international,firstSeats, busSeats, econSeats,aircraftNum);
