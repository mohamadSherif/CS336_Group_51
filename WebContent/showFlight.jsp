...
<html>
	...
	try {
		...
		while (result.next()) {
			...
			out.print("<td>");
			out.print("<input type='text' name='flightNum' value= '"+ result.getInt("flightNumber")+"' disabled/>");
			session.setAttribute("flightNum",result.getInt("flightNumber"));
			out.print("</td>");
			out.print("<td>");
			out.print("<input type='text' name='airline' value= '"+ result.getString("airline_name")+"'/>");
			out.print("</td>");
			out.print("<td>");
			...
			out.print("</td>");
			out.print("<td>");
			out.print("<input type='text' name='departAirport' value= '"+ result.getString("depart_airport_name")+"'/>");
			out.print("</td>");
			out.print("<td>");
			...
			out.print("</td>");
			out.print("<td>");
			out.print("<input type='text' name='arriveAirport' value= '"+ result.getString("arrival_airport_name")+"'/>");
			out.print("</td>");
			out.print("<td>");
			out.print("<input type='text' name='aircraft_num' value= '"+ result.getInt("aircraft_num")+"'/>");
			out.print("</td>");
			out.print("<td>");
