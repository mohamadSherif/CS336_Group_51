	...
	%>
        ...
        <div class="topnav">
          ...
          <div class="cust_rep_dash">
            ...
            <button class="button" >Customer Rep/Customer Information</button>
			<button class="button" >Obtain Sales Report</button>
			<button class="button" >List of Reservations</button>
			<button class="button" >Revenue Generated</button>
            </div>
